...
void CInput::Send(std::basic_string<char, std::char_traits<char>, std::allocator<char>> szString) {
    ((void(__thiscall*)(CInput*, const char*))GetAddress(0x65C60))(this, szString.c_str());
}
